                ...
                <nav
                    ...
                    <div class="header-nav-inner">
                        <ul
                            ...
                            <li>
                                <router-link to="/mobile-core-network/">Mobile core network</router-link>
                            </li>
                        </ul>
                        <ul v-if="!hideSignin" class="list-reset header-nav-right">
                            <li>
                                <router-link to="/contact/" class="button button-wide-mobile button-sm">Talk to an expert</router-link>
                            </li>
                        </ul>
                    </div>
                </nav>
